...
inline System::Void Reform::MyForm::cell1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	button2->Visible = false;
	button3->Visible = false;
	pictureBox1->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/Rock.jpg";
	pictureBox1->Load();
...
inline System::Void Reform::MyForm::cell2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	button2->Visible = false;
	button3->Visible = false;
	pictureBox1->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/Paper.jpg";
	pictureBox1->Load();
...
inline System::Void Reform::MyForm::cell3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	button2->Visible = false;
	button3->Visible = false;
	pictureBox1->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/scissors.png";
	pictureBox1->Load();
