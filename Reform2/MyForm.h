...
namespace Reform {
	...
	public:
		...
		void GameStart() {
			...
			if (rounds==1)
			{
				pictureBox1->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/whut.png";
				pictureBox2->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/whut.png";
				pictureBox1->Load();
				pictureBox2->Load();
			}
		...
		void OpponentMoveView() {
			...
			{
			case 'r':
				pictureBox2->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/Rock.jpg";
				break;
			case 'p':
				pictureBox2->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/Paper.jpg";
				break;
			case 's':
				pictureBox2->ImageLocation = "E:/Codes(2021)/Reform2/Release/Pictures/scissors.png";
				break;
			default:
				break;
			}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox2->Size = System::Drawing::Size(173, 163);
